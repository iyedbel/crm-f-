...
// Identifiant du vendeur connecté
...
// Query to fetch product data specific to the logged-in vendor
$sql = "SELECT nom_produit, prix_vente FROM colis WHERE id_vendeur = ?";
