...
<body class="bg-gray-50">
    ...
    <div class="container-box mx-auto py-8">
        <h2 class="text-3xl font-bold mb-6 text-center">LISTE DES COMPTABLES</h2>
        <a class="btn btn-info mr-2 py-1 px-2 rounded-md bg-blue-500 text-white hover:bg-blue-600 mb-4 inline-block" href="/CRM/creatcompt.php" role="button">Ajouter un comptable</a>
        <div>
            ...
            <table class="table-auto w-full bg-white shadow-lg rounded-lg overflow-hidden">
                ...
                <tbody>
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        echo "<tr><td colspan='6'>Aucun comptable trouvé</td></tr>";
                    }
